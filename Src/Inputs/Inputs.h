...
public:
  ...
  // Training Mode
  std::shared_ptr<CSwitchInput> uiRecordSlot1;
  std::shared_ptr<CSwitchInput> uiRecordSlot2;
  std::shared_ptr<CSwitchInput> uiRecordSlot3;
  std::shared_ptr<CSwitchInput> uiPlaySlot1;
  std::shared_ptr<CSwitchInput> uiPlaySlot2;
  std::shared_ptr<CSwitchInput> uiPlaySlot3;
  std::shared_ptr<CSwitchInput> uiSwitchPlayer;
  std::shared_ptr<CSwitchInput> uiTogglePlayLoop;
  std::shared_ptr<CSwitchInput> uiPlayRandomSlot;
  std::shared_ptr<CSwitchInput> uiTakeoverReplay1;
  std::shared_ptr<CSwitchInput> uiTakeoverReplay2;
  std::shared_ptr<CSwitchInput> uiClipRecord;
